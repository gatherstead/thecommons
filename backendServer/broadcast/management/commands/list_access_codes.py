...
class Command(BaseCommand):
    help = "List all access codes (id, hash prefix, label, kind, tier, uses, active, expiry)."
    ...
    def handle(self, *args, **options):
        ...
        header = (
            f"{'ID':>5}  {'HASH':8}  {'LABEL':<24}  {'KIND':7}  {'TIER':4}  "
        ...
        for code in codes:
            ...
            self.stdout.write(
                f"{code.id:>5}  {hash_prefix:8}  {label:<24}  {code.kind:<7}  {code.tier:>4}  "
