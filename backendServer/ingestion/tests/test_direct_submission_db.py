...
EVENT = {
    ...
    "zip": "27510",
    "locality": ["carrboro"],
    # Suite 50 retired event categories, but the broadcast SPA still sends this
    # key. Kept deliberately: DirectSubmitEventSerializer no longer declares it,
    # so a passing test here proves the extra key is tolerated rather than
    # 400-ing the host during the SPA/backend deploy skew.
    "categories": ["music"],
    "event_url": "",
