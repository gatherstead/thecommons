...
**Future work:**
- Make the newsletter look better visually.
- Figure out how to send events a user may prefer — for example, from their town, or
  with filters they use a lot.
- Newsletter delivery needs a correctness pass — worth verifying end-to-end before
  relying on it.
