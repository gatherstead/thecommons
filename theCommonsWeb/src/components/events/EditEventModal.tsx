...
export function EditEventModal({ isOpen, onClose, eventId, token, towns, onSuccess }: EditEventModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            await updateStagedEvent(token, eventId, {
                title: formData.name,
